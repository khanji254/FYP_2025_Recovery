...
\paragraph{Mechanical Design Integration (Updated Models)}
The latest mechanical package introduces revised battery-case geometry, improved threaded-rod routing clearances, and a cross-sectional avionics bay layout for manufacturability and maintenance access. The updated models in Figures~\ref{fig:fc_holder_cad_updated}--\ref{fig:threaded_rod_integration} are sourced from the current design folder and will be used as the fabrication baseline for the full report.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{../images/mechanical/FC_Holder Cad.jpeg}
\caption{Updated flight-computer holder CAD model showing revised mounting and battery seating features}
\label{fig:fc_holder_cad_updated}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.80\textwidth]{../images/mechanical/Cross_sectional view of avionics bay .jpeg}
\caption{Cross-sectional view of the avionics bay indicating internal clearances and component stacking}
\label{fig:cross_section_avionics}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.80\textwidth]{../images/mechanical/Threaded_Rod_Integration_showing raised battery cells to give way to threaded rods.PNG}
\caption{Threaded-rod integration with raised battery cells to preserve structural alignment and wiring space}
\label{fig:threaded_rod_integration}
\end{figure}
