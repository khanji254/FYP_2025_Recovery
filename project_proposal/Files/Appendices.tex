...
\section{Mechanical Design Drawings (Current Iteration)}
\label{appendix:mechanical_drawings}

This appendix consolidates the latest mechanical design files provided in the project mechanical-image folder. These figures are included as formal drawing references for fabrication and design review.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\textwidth]{../images/mechanical/18650_case_cover.pdf}
\caption{18650 battery case cover drawing (current revision)}
\label{fig:mech_case_cover}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\textwidth]{../images/mechanical/Edge_Batt.pdf}
\caption{Edge battery support plate drawing}
\label{fig:mech_edge_batt}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\textwidth]{../images/mechanical/mid_Batt.pdf}
\caption{Mid battery support plate drawing}
\label{fig:mech_mid_batt}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{../images/mechanical/Avionics assembly.jpeg}
\caption{Avionics assembly integration view}
\label{fig:mech_avionics_assembly}
\end{figure}
