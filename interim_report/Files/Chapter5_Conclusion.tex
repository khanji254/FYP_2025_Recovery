...
\begin{enumerate}
  ...
  \item \textbf{Centroid tracking integration:} Implement a lightweight centroid tracker to associate detections across frames and calculate berry position on the belt relative to the ejection zone.
  ...
  \item \textbf{Physical integration:} Mount the Pi Camera above the conveyor detection window, calibrate belt-speed-to-timing offset, and wire the solenoid driver circuits.
  \item \textbf{Throughput benchmarking:} Measure berries per minute at several belt speeds and identify the optimal operating point.
...
The budget summary is provided in Appendix~\ref{app:schedule_budget}.
